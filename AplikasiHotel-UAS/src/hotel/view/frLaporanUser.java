 ...
 */
public class frLaporanUser extends javax.swing.JFrame {

    UserDAO dao = new UserDAO();
    
    public frLaporanUser() {
        initComponents();
        loadTable();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frLaporanUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frLaporanUser().setVisible(true);
            }
        });
    }
