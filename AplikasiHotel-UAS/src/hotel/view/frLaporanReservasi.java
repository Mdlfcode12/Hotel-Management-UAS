 ...
 */
public class frLaporanReservasi extends javax.swing.JFrame {

    ReservasiDAO dao = new ReservasiDAO();
    DefaultTableModel model;
    
    public frLaporanReservasi() {
        initComponents();
        loadTable();
    }
    ...
    private void initComponents() {
        ...
        jpanel.setViewportView(tblReservasi);
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        String fileLaporan = "src/hotel/laporan/ReservasiReport.jasper"; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frLaporanReservasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frLaporanReservasi().setVisible(true);
            }
        });
    }
